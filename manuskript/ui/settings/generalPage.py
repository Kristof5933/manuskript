...
class GeneralPage(AbstractPage):
    ...
    def __init__(self, settings: Settings):
        ...
        self.saveOnQuit.connect("toggled", self._genericSpinButtonValueChanged, SettingsKeys.SAVE_ON_QUIT)
        self.saveToZip.connect("toggled", self._genericSpinButtonValueChanged, SettingsKeys.SAVE_TO_ZIP)
